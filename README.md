...
## Description
`zprop.test` can be used for testing whether a population proportion is equal to a specified null value.  Notably, it also provides hypothesis intervals that are consistent with the associated z test statistic.  
